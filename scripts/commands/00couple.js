...
module.exports.onLoad = async() => {
  ...
  const path = resolve(__dirname, 'cache/canvas', 'couplev3.png');
...
async function makeImage({ one, two }) {
  ...
  batgiam_img.composite(circleOne.resize(200, 200), 20, 300).composite(circleTwo.resize(150, 150), 100, 20);
